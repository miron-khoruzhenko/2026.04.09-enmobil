export const FAQ_DATA = [
  ...
  {
    id: 5,
    question: "Birden fazla araç için sigorta yaptırabilir miyim?",
    answer: "Evet. Enmobil, filo sahipleri ve kurumsal müşteriler için toplu araç sigortası paketleri sunmaktadır. 5 ve üzeri araç için özel fiyatlandırma fırsatlarından yararlanabilirsiniz."
  },
  {
    id: 6,
    question: "Poliçemi dijital olarak alabilir miyim?",
    answer: "Evet. Teklif formunu doldurduktan sonra poliçeniz e-posta adresinize dijital olarak iletilir. Fiziksel baskı veya ıslak imza gerektiren işlemler için ekibimiz size yol gösterecektir."
  }
];
